...
<p><input type="text" name="name" placeholder="Enter titulo" 
required value="<?php echo $row['titulo'];?>" /></p>
<p><input type="text" name="age" placeholder="Enter cuerpo" 
required value="<?php echo $row['cuerpo'];?>" /></p>
